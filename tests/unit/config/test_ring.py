...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("ring:\n    path: /opt/1C/v8.3/x86_64",
         RingConfig("/opt/1C/v8.3/x86_64", "")),
        ("ring:\n    path: /opt/1C/v8.3/x86_64\n    java: /usr/lib/jvm/java-8-oracle",
         RingConfig("/opt/1C/v8.3/x86_64", "/usr/lib/jvm/java-8-oracle")),
        ("ring:\n    path: C:\\Program Files\\1C\\1CE\\ring\n    java: C:\\Program Files\\Java\\jre-9.0.1",
         RingConfig(r"C:\Program Files\1C\1CE\ring", r"C:\Program Files\Java\jre-9.0.1"))
    ],
